...
public class ImogSingleRelationBoxPopUp<T extends ImogBeanProxy> {
	...
	public ImogSingleRelationBoxPopUp(ImogSingleRelation<T> parentBoxValue, ImogBeanDataProvider<T> provider,
			ImogBeanRenderer beanRenderer) {
